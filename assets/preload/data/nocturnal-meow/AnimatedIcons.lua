...
function onCreatePost()
	makeAnimatedLuaSprite('icons1', 'icon-Animated/nermal', getProperty('iconP1.x'), getProperty('iconP1.y'))
...
--------------------------------------------------------------------------------------------------------------------------------
	makeAnimatedLuaSprite('icons2', 'icon-Animated/monsterfield', getProperty('iconP2.x'), getProperty('iconP2.y'))
...
---------------------------------------------------------------------------------------------------------------------------------
	...
	setProperty('icons2.y', getProperty('iconP2.y') + 10) -- and here
