...
makeLuaSprite('health_pixel', 'healthbar_pixel_orange', 214, 15)
addLuaSprite('health_pixel', false)
scaleObject('health_pixel', 3.13, 3.13)
setObjectCamera('health_pixel', 'hud')
...
setObjectOrder('health_pixel', getObjectOrder('health_pixel') + 1);
...
if not mustHitSection == true then
   doTweenAlpha('tweenHealthS', 'healthBar', 1, 0.3, linear)
    ...
    doTweenAlpha('tweeniconP22', 'iconP1', 1, 0.3, linear)
		doTweenAlpha('tweenScoreSS', 'iconP2', 1, 0.3, linear)
    ...
    doTweenAlpha('tweeniconn', 'iconP1', 0.3, 0.3, linear)
		doTweenAlpha('tweenScoree', 'iconP2', 0.3, 0.3, linear)
