...
makeAnimatedLuaSprite('icons2', 'icon-Animated/BF_sansfield_ingame', getProperty('iconP1.x'), getProperty('iconP1.y'))
...
luaSpriteAddAnimationByPrefix('icons2', 'losing', 'losing', 24, true); 
	...
	setProperty('icons2.flipX', true) --mirror sprite horizontally
...
setProperty('icons2.x', getProperty('iconP1.x') + 10) -- change here
	setProperty('icons2.angle', getProperty('iconP1.angle'))
	setProperty('icons2.y', getProperty('iconP1.y') + 20) -- and
---------------------------------------------------------------------------------------------------------------------------------
