...
--Two
                    makeLuaSprite('CountTwo', 'binky/Ready_blue', 0, 250)

	setObjectCamera('CountTwo', 'other')
	setProperty('CountTwo.visible', false)
--One
	makeLuaSprite('CountOne', 'binky/Set_blue', 0, 250)

	setObjectCamera('CountOne', 'other')
	setProperty('CountOne.visible', false)
--Go	
	makeLuaSprite('CountGO', 'binky/play_blue', 0, 200)
...
function onUpdate()
  ...
  setProperty('CountGO.x', getProperty('countdownGo.x') + 100)
end
