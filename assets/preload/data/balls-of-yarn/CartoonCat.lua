...
characterTag = 'cartooncat' -- Set this to what the sprite should be named.
...
--]]
animationData = {
    ['idle'] = {'idle', 630, 10, '', false},


    ['singLEFT'] = {'left', 672, 20, '', false},
    ['singDOWN'] = {'down', 689, 100, '', false},
    ['singUP'] = {'up', 804, 250, '', false},
    ['singRIGHT'] = {'right', 590, -44, '', false},
